...
/**
 * insertion_sort_deck_kind - Sort of cards from spades to diamonds.
...
/**
 * insertion_sort_deck_value - Sort cards sorted from
...
/**
 * sort_deck - Sort cards from ace to king and
